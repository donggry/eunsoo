...
// connect database
mongoose.connect("mongodb://test:testtest@ds051615.mlab.com:51615/scrum6");
...
var User = mongoose.model('testddddd',userSchema);
...
app.get('/posts', function(req,res){
  Post.find({}).sort('-createdAt').exec(function (err,posts) {
	try{
		user_email = JSON.stringify(req.user.email);
	}catch(err){}
    if(err) return res.json({success:false, message:err});
...
var server= app.listen(36789, function(){
